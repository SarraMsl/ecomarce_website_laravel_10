...
border: 4px dashed #ddd;
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Ajouter une nouvelle produits</li>
                </ol>
            </nav>
        </div>
  ...
  <div class="card">
      <div class="card-body p-4">
          <h5 class="card-title">Ajouter une nouvelle produits</h5>
          <hr/>
           <div id="myForm" class="form-body mt-4"> 
          <form action="{{route('admin.produits.store.produits')}}" enctype="multipart/form-data" method="POST">
                          @csrf
                  ...
                  <div class="row g-3">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="input-group">
                          <input type="text" class="form-control"id="inputCostPerPrice" name="purchase_price" aria-label="Dollar amount (with dot and two decimal places)"placeholder="Prix D'achat" required> <span class="input-group-text">DA</span>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="input-group">
                          <input type="text" class="form-control" id="inputProfitPercentage" name="interest_percentage" aria-label="Dollar amount (with dot and two decimal places)" required> <span class="input-group-text">%</span>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="input-group">
                          <input type="text" class="form-control"id="inputSellingPrice" name="selling_price" aria-label="Dollar amount (with dot and two decimal places)"placeholder="Prix D'achat" required> <span class="input-group-text" >DA</span>
                        </div>
                      </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control"id="calculatedProfitPercentage" name="calcul_percentage" aria-label="Dollar amount (with dot and two decimal places)" disabled> <span class="input-group-text">%</span>
                      </div>
                    </div>
                   <div class="col-12">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="input-group">
                          <input type="text" class="form-control" name="hauteur" aria-label="Dollar amount (with dot and two decimal places)"placeholder="Ex:1000x1200"required > <span class="input-group-text">cm</span>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <label for="inputProductType" class="form-label">Largeur</label>
                        <div class="input-group">
                          <input type="text" class="form-control" name="largeur" aria-label="Dollar amount (with dot and two decimal places)"placeholder="Ex:1000x1200"required > <span class="input-group-text">cm</span>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        ...
                        <input type="text" class="form-control " id="inputStarPoints" name="varnish" placeholder="Vernis" required>
                      </div>
                      <div class="col-md-12">
                        <label for="inputProductType" class="form-label">Quantité</label>

                        <input type="text" class="form-control " id="inputStarPoints" name="quantité" placeholder="Quantité" required>
                      </div>
                      <div class="col-md-12">
                        <label for="inputProductType" class="form-label">Couleurs</label>

                        <input type="color" class="form-control " id="inputStarPoints" name="colors[]" placeholder="Ex:Noir" required>
                      </div>
                      <div class="col-md-12">
                        <label for="inputProductType" class="form-label">Lieu D'utilisation</label>

                        <label for="inputStarPoints" class="form-label"></label>
                        <input type="text" class="form-control " id="inputStarPoints" name="usage_location" placeholder="Lieu D'utilisation" required>
                      </div>
